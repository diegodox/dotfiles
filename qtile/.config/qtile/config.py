...
keys = [
        ...
        Key([mod], "q", lazy.spawn(os.path.expanduser('~') + '/.config/qutebrowser/debug.sh')),
        ]
...
if __name__ in ["config", "__main__"]:
    ...
    groups = [
            Group("WWW", matches = [Match(wm_class=["google-chrome", "qutebrowser"])]),
...
layouts = [
        layout.Columns(
            border_focus=gruvbox_colors["green"][0],
            border_width = 3,
            num_columns=3,
            margin=[3,5,3,5],
            margin_on_single = 7
                ...
                [
                    ...
                    widget.PulseVolume(
                        ...
                        mouse_callbacks = {
                            ...
                            # Right click to open mixer
                            'Button3': lambda: qtile.cmd_spawn(terminal + ' -e pulsemixer')
                            }
                        ),
                    widget.Sep(padding=separeter_padding, foreground=separeter_foreground),
                    widget.CheckUpdates(
                    ...
                    widget.Sep(padding=separeter_padding, foreground=separeter_foreground),
                    #widget.TextBox(text='ethtool eno1 2>/dev/null | grep "Speed:" | sed -e \'s/Speed: //g\''),
                    #widget.Sep(padding=separeter_padding, foreground=separeter_foreground),
